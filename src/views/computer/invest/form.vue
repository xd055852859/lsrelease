  ...
  <div class="investForm">
    ...
    <div class="investForm-box form">
      <div v-show="formTab == 'base'">
        ...
        <div class="form-item">
          <div class="form-item-title">资源面积</div>
        ...
        <div class="form-item">
          <div class="form-item-title">水体</div>
          <div class="form-item-input dp-space-center">
            <q-input
              dense
              outlined
        ...
        <div class="form-item">
          <div class="form-item-title investInfo-subtitle" style="width: 100%">
            转换证明
          </div>
