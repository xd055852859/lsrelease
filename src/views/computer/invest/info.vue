...
const downloadFile = (url, name) => {
  ...
  a.href = url + "?response-content-type=application/octet-stream"; // 给a标签的href属性值加上地址，注意，这里是绝对路径，不用加 点.
  a.download = url.split("_")[1]; //设置下载文件文件名，这里加上.xlsx指定文件类型，pdf文件就指定.fpd即可
