...
const getHomeList = async () => {
  ...
  if (resourceRes.msg === "OK") {
    productList.value = resourceRes.data.productList;
    ...
    <div class="container">
      <div class="container-button">
        <div class="button-item-box">
          <div
            class="button-item"
            @click="user ? $router.push({ name: 'phoneinvestForm' }) : login()"
          >
          ...
          <div
            class="button-item"
            @click="user ? $router.push({ name: 'phoneproductForm' }) : login()"
          >
        ...
        <div class="button-item-box">
          <div
            class="button-item"
            @click="$router.push({ name: 'computerproduct' })"
          >
      ...
      <div class="container-item">
        ...
        <div class="dp-center-center">
          <div
            class="common-box"
            style="justify-content: space-between; width: 95vw"
          >
            <div class="container-chart">
              <ring-chart
                v-if="conversionList"
                ringId="firstRing"
                :chartData="conversionList"
                chartName="转化情况"
              />
            </div>
            <div class="container-chart">
      ...
      <div class="container-item">
        <div class="container-title">
          <div>重点项目推介</div>
          <div
            @click="$router.push({ name: 'computerinvest' })"
            class="icon-point"
          >
            更多
            <q-icon
        ...
        <div class="container-product">
          ...
          >
            ...
            :name="index" -->
            <template
              v-for="(item, index) in resouceList"
              :key="`case${index}`"
            >
              <q-carousel-slide
                class="q-pa-none"
              ...
              >
                <div
                  class="container-case-img icon-point"
                  @click="
                    $router.push({
      ...
      <div class="container-item">
        ...
        <div class="container-resource">
          ...
          >
            ...
            >
              <q-carousel-slide
                class="q-pa-none container-case-box"
                :name="`project${index}`"
              >
                <div
                  ...
                  "
                >
                  <resource-item :item="item" tabType="product" type="home" />
                </div>
              </q-carousel-slide>
            </template>
          </q-carousel>
