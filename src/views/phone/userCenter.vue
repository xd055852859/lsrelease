    ...
    <div class="userCenter-box">
      <div class="userCenter-top">
        <q-tabs
          ...
          mobile-arrows
        >
          <q-tab name="user" label="用户信息" />
          <q-tab name="resouce" label="发布资源" />
          <q-tab name="invest" label="转化招商" />
          <q-tab name="product" label="发布产品" />
          <q-tab name="intention" label="意向资源" />
        </q-tabs>

      </div>
      <div class="userCenter-bottom common-box">
